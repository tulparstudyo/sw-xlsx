...
namespace Aimeos\Controller\Common\Product\Import\Xlsx\Cache\Supplier;
...
{
	/** controller/common/product/import/xlsx/cache/supplier/name
	 * Name of the supplier cache implementation
	 *
	 * Use "Myname" if your class is named "\Aimeos\Controller\Common\Product\Import\Xlsx\Cache\Supplier\Myname".
