...
namespace Aimeos\Controller\Common\Product\Import\Xlsx\Processor;
	...
	extends \Aimeos\Controller\Common\Product\Import\Xlsx\Base
{
	 ...
	 * @return \Aimeos\Controller\Common\Product\Import\Xlsx\Processor\Iface Same object for fluent interface
	 */
	 ...
	 */
	protected function getObject() : \Aimeos\Controller\Common\Product\Import\Xlsx\Processor\Iface
	{
		if( $this->object === null ) {
