...
namespace Aimeos\Controller\Common\Product\Import\Xlsx\Processor\Attribute;
...
{
	/** controller/common/product/import/xlsx/processor/attribute/name
	 * Name of the attribute processor implementation
	 *
	 * Use "Myname" if your class is named "\Aimeos\Controller\Common\Product\Import\Xlsx\Processor\Attribute\Myname".
		...
		\Aimeos\Controller\Common\Product\Import\Xlsx\Processor\Iface $object = null )
	{
		...
		/** controller/common/product/import/xlsx/processor/attribute/listtypes
		 ...
		 * @see controller/common/product/import/xlsx/processor/catalog/listtypes
		 ...
		 */
		$key = 'controller/common/product/import/xlsx/processor/attribute/listtypes';
	...
	public function process( \Aimeos\MShop\Product\Item\Iface $product, array $data ) : array
	{
		...
		{
            // tulpar studyo
            $list = ['attribute.code'=>'', 'attribute.lists.type'=>'standard'];
