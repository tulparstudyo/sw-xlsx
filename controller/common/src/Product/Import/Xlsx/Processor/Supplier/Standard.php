...
namespace Aimeos\Controller\Common\Product\Import\Xlsx\Processor\Supplier;
...
{
	/** controller/common/product/import/xlsx/processor/supplier/name
	 * Name of the supplier processor implementation
	 *
	 * Use "Myname" if your class is named "\Aimeos\Controller\Common\Product\Import\Xlsx\Processor\Supplier\Myname".
		...
		\Aimeos\Controller\Common\Product\Import\Xlsx\Processor\Iface $object = null )
	{
		...
		/** controller/common/product/import/xlsx/processor/supplier/listtypes
		 ...
		 */
		$key = 'controller/common/product/import/xlsx/processor/supplier/listtypes';
