...
namespace Aimeos\Controller\Common\Product\Import\Xlsx\Processor\Price;
...
{
	/** controller/common/product/import/xlsx/processor/price/name
	 * Name of the price processor implementation
	 *
	 * Use "Myname" if your class is named "\Aimeos\Controller\Common\Product\Import\Xlsx\Processor\Price\Myname".
			...
			\Aimeos\Controller\Common\Product\Import\Xlsx\Processor\Iface $object = null )
	{
		...
		/** controller/common/product/import/xlsx/processor/price/listtypes
		 ...
		 */
		$key = 'controller/common/product/import/xlsx/processor/price/listtypes';
