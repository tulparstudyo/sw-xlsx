...
namespace Aimeos\Controller\Common\Product\Import\Xlsx\Processor\Text;
...
{
	/** controller/common/product/import/xlsx/processor/text/name
	 * Name of the text processor implementation
	 *
	 * Use "Myname" if your class is named "\Aimeos\Controller\Common\Product\Import\Xlsx\Processor\Text\Myname".
			...
			\Aimeos\Controller\Common\Product\Import\Xlsx\Processor\Iface $object = null )
	{
		...
		/** controller/common/product/import/xlsx/processor/text/listtypes
		 ...
		 */
		$key = 'controller/common/product/import/xlsx/processor/text/listtypes';
