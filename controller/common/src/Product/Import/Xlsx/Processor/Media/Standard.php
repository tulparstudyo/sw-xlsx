...
namespace Aimeos\Controller\Common\Product\Import\Xlsx\Processor\Media;
...
{
	/** controller/common/product/import/xlsx/processor/media/name
	 * Name of the media processor implementation
	 *
	 * Use "Myname" if your class is named "\Aimeos\Controller\Common\Product\Import\Xlsx\Processor\Media\Myname".
			...
			\Aimeos\Controller\Common\Product\Import\Xlsx\Processor\Iface $object = null )
	{
		...
		/** controller/common/product/import/xlsx/processor/media/listtypes
		 ...
		 */
		$key = 'controller/common/product/import/xlsx/processor/media/listtypes';
