...
namespace Aimeos\Controller\Common\Product\Import\Xlsx\Processor\Product;
...
{
	/** controller/common/product/import/xlsx/processor/product/name
	 * Name of the product processor implementation
	 *
	 * Use "Myname" if your class is named "\Aimeos\Controller\Common\Product\Import\Xlsx\Processor\Product\Myname".
		...
		\Aimeos\Controller\Common\Product\Import\Xlsx\Processor\Iface $object = null )
	{
		...
		/** controller/common/product/import/xlsx/processor/product/listtypes
		 ...
		 */
		$key = 'controller/common/product/import/xlsx/processor/product/listtypes';
	...
	public function process( \Aimeos\MShop\Product\Item\Iface $product, array $data ) : array
	{
		...
		{
           // tulpar studyo
            $list = ['product.code'=>'', 'product.lists.type'=>'standard'];
