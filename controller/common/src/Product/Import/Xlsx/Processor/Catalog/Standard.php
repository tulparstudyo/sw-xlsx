...
namespace Aimeos\Controller\Common\Product\Import\Xlsx\Processor\Catalog;
 ...
 */
class Standard
	extends \Aimeos\Controller\Common\Product\Import\Xlsx\Processor\Base
	implements \Aimeos\Controller\Common\Product\Import\Xlsx\Processor\Iface
{
	/** controller/common/product/import/xlsx/processor/catalog/name
	 * Name of the catalog processor implementation
	 *
	 * Use "Myname" if your class is named "\Aimeos\Controller\Common\Product\Import\Xlsx\Processor\Catalog\Myname".
	...
	public function __construct( \Aimeos\MShop\Context\Item\Iface $context, array $mapping,
		\Aimeos\Controller\Common\Product\Import\Xlsx\Processor\Iface $object = null )
	{
		parent::__construct( $context, $mapping, $object );

		/** controller/common/product/import/xlsx/processor/catalog/listtypes
		 ...
		 * @category Developer
		 * @category User
		 * @see controller/common/product/import/xlsx/domains
		 * @see controller/common/product/import/xlsx/processor/attribute/listtypes
		 * @see controller/common/product/import/xlsx/processor/media/listtypes
		 * @see controller/common/product/import/xlsx/processor/price/listtypes
		 * @see controller/common/product/import/xlsx/processor/product/listtypes
		 * @see controller/common/product/import/xlsx/processor/text/listtypes
		 */
		$key = 'controller/common/product/import/xlsx/processor/catalog/listtypes';
	...
	public function process( \Aimeos\MShop\Product\Item\Iface $product, array $data ) : array
	{
		...
		/** controller/common/product/import/xlsx/separator
		 ...
		 * @category User
		 * @category Developer
		 * @see controller/common/catalog/import/xlsx/domains
		 * @see controller/common/supplier/import/xlsx/domains
		 */
		$separator = $context->getConfig()->get( 'controller/common/product/import/xlsx/separator', "\n" );
...
// echo " - Sub process: ".get_class($this->getObject())."\r\n";
	...
	protected function checkEntry( array $list ) : bool
	{
		...
		{
			$msg = sprintf( 'Invalid type "%1$s" (%2$s)', $type, 'catalog list-Catalog' );
